...
export function WhatsAppFloat() {
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_28px_rgba(37,211,102,0.45)] transition-transform hover:scale-105 hover:shadow-[0_10px_32px_rgba(37,211,102,0.55)] md:bottom-7 md:right-7 md:h-16 md:w-16"
